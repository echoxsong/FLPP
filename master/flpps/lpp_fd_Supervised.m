function flppstr = lpp_fd_Supervised(fdobj, L, L_Prime, nharm, harmfdPar, centerfns)
...
%  This line was wrong:   Junbin Gao
...
if nvar == 1
    Lmat = W * Cmat * L_Prime * Cmat' * W;
    Rmat = W * Cmat * L * Cmat' * W;
%     Rmat = W * Cmat * D * Cmat' * W;    
    Lmat = (Lmat + Lmat') / 2;
    Rmat = (Rmat + Rmat') / 2;
%     Lmat = Lmat + eye(size(Lmat))*eps(1); %add eps
