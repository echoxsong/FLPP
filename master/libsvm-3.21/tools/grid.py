...
class GridOption:
	def __init__(self, dataset_pathname, options):
		...
		if sys.platform != 'win32':
			...
			# example for windows
			self.svmtrain_pathname = os.path.join(dirname, r'D:\Program Files\MATLAB\R2012b\toolbox\libsvm-3.21\windows\svm-train.exe')
			# svmtrain_pathname = r'c:\Program Files\libsvm\windows\svm-train.exe'
			self.gnuplot_pathname = r'D:\Program Files (x86)\gnuplot\bin\gnuplot.exe'
		self.fold = 5
